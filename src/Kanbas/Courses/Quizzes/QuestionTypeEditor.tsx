...
const QuestionTypeEditor = ({ question, onSave, onCancel }: { question: any; onSave: (question: any) => void; onCancel: () => void }) => {
        ...
        <div className="question-editor p-3">
            ...
            {type === 'MULTIPLE_CHOICE' && (
                <div className="mb-3">
                    ...
                    <button type="button" className="btn btn-link text-danger" onClick={handleAddChoice}>
                        + Add Another Answer
                    </button>
                </div>
            )}
            ...
            {type === 'FILL_IN_BLANK' && (
                <div className="mb-3">
                    ...
                    <button type="button" className="btn btn-link text-danger" onClick={handleAddBlankAnswer}>
